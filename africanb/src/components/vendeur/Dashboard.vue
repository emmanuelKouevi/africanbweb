    ...
    <v-app>
        <v-container fluid>
                ...
                <div class="col-lg-3">
                    <v-card rounded="lg" color="#273c75">
                        ...
                        <v-card-text>
                            <v-container>
                                <v-row justify="center">
                                    <span class="libelle font-weight-bold">258.015 </span>&nbsp;&nbsp;<span class="cfa">FCFA</span>
                                </v-row>
                            </v-container>
                        </v-card-text>
                    </v-card>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <v-card>
                        <v-card-title>Reservations récentes
                            <v-spacer></v-spacer>
                ...
                <div class="col-lg-4">
                    <v-card rounded="lg" color="#2f3640">
                        <v-card-title><span class="card-title-text">Reservations Récentes</span></v-card-title>
                        <v-card-text>
                            <v-container>
                                <v-row justify="center">
                        ...
                        <v-card-actions>
                            <v-btn x-small text><span class="btn-libelle">Plus de détail</span></v-btn>
                        </v-card-actions>
                    </v-card>
                </div>
            </div>
