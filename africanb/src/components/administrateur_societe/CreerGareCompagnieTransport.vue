          ...
          <v-card width="1200" elevation="3">
            ...
            <v-container>
              <v-row>
                <v-col cols="5">
                  <v-text-field
                    :error-messages="designationGareErrors"
                    rounded
                    dense
                    outlined
                    label="Désignation de la gare"
                    v-model.trim="$v.gareTransportModel.designation.$model"
                  ></v-text-field>
                </v-col>
                <v-col cols="5">
                  <v-text-field
                    :error-messages="emailGareErrors"
                    rounded
                    dense
                    outlined
                    label="E-mail"
              ...
              <v-row>
                <v-col cols="5">
                  <v-text-field
                    type="tel"
                    :error-messages="premierTelephoneGareErrors"
                    rounded
                    dense
                    outlined
                    label="Téléphone N°1"
              ...
              <v-row>
                <v-col cols="5">
                  <v-text-field
                    :error-messages="addresseLocalisationGareError"
                    rounded
                    dense
                    outlined
                    label="Addresse de la gare"
                    v-model.trim="
