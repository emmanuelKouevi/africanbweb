      ...
      <v-container fluid>
        <v-card width="1200" elevation="3">
          ...
          <v-card-actions>
            ...
            <v-btn small type="submit" rounded outlined color="teal"
  ...
  methods: {
    ...
    async modifierModePrixOffreVoyage() {
      ...
      await axios
        .put(
          ...
          this.prixModeOffreVoyageToModify,
    ...
    async editerModeOffreVoyage() {
      if (localStorage.getItem("modeOffreVoyage")) {
        try {
          const modeOffreVoyageEditing = JSON.parse(
            localStorage.getItem("modeOffreVoyage")
          );
          this.prixOffreVoyageModel.id = modeOffreVoyageEditing.id;
          this.prixOffreVoyageModel.designation =
            modeOffreVoyageEditing.designation;
          this.prixOffreVoyageModel.offreVoyageDesignation =
            modeOffreVoyageEditing.offreVoyageDesignation;
          this.prixOffreVoyageModel.categorieVoyageurDesignation =
            modeOffreVoyageEditing.categorieVoyageurDesignation;
          this.prixOffreVoyageModel.modeDesignation =
            modeOffreVoyageEditing.modeDesignation;
