        ...
        <v-card width="1200" elevation="3">
          ...
          <v-card-text>
            <div class="form-group col-md-6">
              ...
              <v-select
                :error-messages="typeAbonnementErrors"
                id="typeAbonnement"
                data-cy="typeAbonnement"
                class="my_input"
                v-model="typeAbonnement"
                :items="referenceAbonnementList"
                dense
                outlined
            ...
            <div v-if="typeAbonnement == 'AbonnementPeriodique'">
              <div class="form-row">
                <div class="form-group col-md-6">
                  <label for="designationAbonnement"
                    >Designation de l'abonnement:</label
                  >
                  <v-text-field
                    :error-messages="designationAbonnementErrors"
                    id="designationAbonnement"
                    dense
                    outlined
                    placeholder="Designation de l'abonnement"
                    data-cy="designationAbonnement"
                    v-model.trim="
                ...
                <div class="form-group col-md-3">
                  ...
                  <v-text-field
                    :error-messages="redevanceAbonnementErrors"
                    id="redevance"
                    dense
                    outlined
                    color="primary"
                    placeholder="redevance"
                    suffix="FCFA"
                    v-model.trim="
                ...
                <div class="form-group col-md-3">
                  ...
                  <v-text-field
                    :error-messages="redevancePubAbonnementErrors"
                    id="redevancePublicite"
                    dense
                    outlined
                    color="primary"
                    placeholder="redevance publicité"
                    data-cy="redevancePublicite"
                    v-model.trim="
                      $v.modeAbonnementPeriodiqueModel.redevancePublicite.$model
                    "
                    suffix="FCFA"
                  >
                  </v-text-field>
              ...
              <div class="form-row">
                <div class="form-group col-md-6">
                  ...
                  <v-select
                    :items="referencePeriodiciteList"
                    item-value="designation"
                    id="periodiciteAbonnement"
                    item-text="designation"
                    :error-messages="periodiciteAbonnementErrors"
                    data-cy="periodiciteAbonnement"
                    dense
                    outlined
                    color="primary"
                    placeholder="périodicité Abonnement"
                    v-model.trim="
                ...
                <div class="form-group col-md-3">
                  ...
                  <v-menu
                    ref="menuDebutAbonnement"
                    v-model="menuDebutAbonnement"
                  ...
                  >
                    <template v-slot:activator="{ on, attrs }">
                      <v-text-field
                        id="dateDebutAbonnement"
                        :error-messages="dateDebutAbonnementErrors"
                        dense
                        outlined
                        v-model="dateDebutAbonnementPeriodique"
                        placeholder="Debut de l'abonnement"
                        append-icon="mdi-clock-time-four-outline"
                        readonly
                        v-bind="attrs"
                        v-on="on"
                        data-cy="dateDebutAbonnement"
                      >
                      </v-text-field>
                    </template>
                    <v-date-picker
                      @input="menuDebutAbonnement = false"
                      v-model="dateDebutAbonnementPeriodique"
                      no-title
                    ></v-date-picker>
                  </v-menu>
                ...
                <div class="form-group col-md-3">
                  <label for="dateFinAbonnement"
                    >Date de fin d'Abonnement</label
                  >
                  <v-menu
                    ref="menuFinAbonnement"
                    v-model="menuFinAbonnement"
                    :close-on-content-click="false"
                    transition="scale-transition"
                    offset-y
                    max-width="290px"
                  ...
                  >
                    <template v-slot:activator="{ on, attrs }">
                      <v-text-field
                        id="dateDebutAbonnement"
                        :error-messages="dateFinAbonnementErrors"
                        dense
                        outlined
                        ...
                        v-bind="attrs"
                        v-on="on"
                        data-cy="dateFinAbonnement"
                      >
                      </v-text-field>
                    </template>
                    <v-date-picker
                      @input="menuFinAbonnement = false"
                      v-model="dateFinAbonnementPeriodique"
                      no-title
                    ></v-date-picker>
                  </v-menu>
