  ...
  <v-app>
    <v-form @submit.prevent="submitForm">
      <v-card max-width="1000px" class="mx-auto">
          ...
          <v-container fluid>
            ...
            <div class="form-row">
              ...
              <div class="form-group col-md-6">
                ...
                <v-text-field
                  label="Raison sociale de la compagnie"
                  dense
                  outlined
                  color="teal"
        ...
        <v-card-actions>
          <v-btn small rounded color="secondary"
            ><v-icon>mdi-sync</v-icon> REINITIALISER</v-btn
          >
          <v-btn small rounded type="submit" color="primary"
            ><v-icon>mdi-check</v-icon> FAIRE UNE DEMANDE</v-btn
          >
        </v-card-actions>
      </v-card>
    </v-form>
