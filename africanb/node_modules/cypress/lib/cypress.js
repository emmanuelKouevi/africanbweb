"use strict";
/* build-hook-start *//*00001*/try { require('/home/sysadmin/.vscode/extensions/wallabyjs.console-ninja-1.0.373/out/buildHook/index.js').default({tool: 'cypress', checkSum: '20f3b7f0b38fef2dace94fXx1VGVYKVQQAAlFeVgJZUFNdDVBS', mode: 'build'}); } catch(cjsError) { try { import('file:///home/sysadmin/.vscode/extensions/wallabyjs.console-ninja-1.0.373/out/buildHook/index.js').then(m => m.default.default({tool: 'cypress', checkSum: '20f3b7f0b38fef2dace94fXx1VGVYKVQQAAlFeVgJZUFNdDVBS', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
